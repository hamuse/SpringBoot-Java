 ...
 * 
 * 
 * @Component("filemgr") public class FileProxy extends Proxy { public void
 * fileupload(MultipartFile[] uploadFile) { String uploadFolder =
 ...
 * public String getFoler() { return currentDate().replace("-", File.separator);
 * } }
 */